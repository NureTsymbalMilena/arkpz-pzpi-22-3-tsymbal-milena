//Код до застосування методу рефакторингу «Видалення параметру»
...
class FollowersActivity : AppCompatActivity(), OnFollowStateChangedListener {
    ...
    private fun getFollowings (userId: String, id: String) {
    ...
    private fun getFollowers (userId: String, id: String) {
        val targetId= if (id.isNotEmpty() && id != userId) id else userId
...
//Код піля застосування методу рефакторингу «Видалення параметру»
